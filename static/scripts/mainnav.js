...
menuIcon.onmouseenter = function () {
  const titleTabsWidth =
    (document.getElementById("titleTabs").clientWidth / document.documentElement.clientWidth) * 100;
  document.getElementById(
    "titleTabs"
  ).style.right = `calc(1.75em + ${profileTitleContainer.clientWidth}px)`;
